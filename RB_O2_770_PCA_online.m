function [sponts6] = RB_O2_770_PCA_online(T,P,nu_Range,Spectrum)
...
muY = Spectrum.RBonline.muY;
M = Spectrum.RBonline.M;
muT = Spectrum.RBonline.muT;
muP = Spectrum.RBonline.muP;
sigmaT = Spectrum.RBonline.sigmaT;
sigmaP = Spectrum.RBonline.sigmaP;
